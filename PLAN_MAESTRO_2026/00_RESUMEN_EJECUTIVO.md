...
| `27_PLAN_V1_A_V16.md` | plan ejecutivo V1.0→V1.6: dependencias, 35 sesiones con modelo+esfuerzo, tests de producto por fase, decisiones (TIE v3 disuelto, Hermes gradual GO/NO-GO) |
