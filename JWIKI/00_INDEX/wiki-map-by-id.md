...
| JWIKI-003 | 01_LANDSCAPE/openclaw.md | OpenClaw (376k stars) | B | ✅ verified | (tick A-20260708-2008 enrich+audit, 5632 palabras, 11 snippets, 32 hechos; superseded por 003b/003c) |
| JWIKI-003b | 01_LANDSCAPE/openclaw-code-audit.md | OpenClaw code-audit (real code 2026-07-13) | extra | 🟢 verified | (tick A-20260713-1312 — clonado repo real, 6923 palabras, 159 path:line, 25 canales/78 providers/65 skills bundled; 6/6) |
| JWIKI-003c | 01_LANDSCAPE/openclaw-architecture.md | OpenClaw architecture (real code 2026-07-13) | extra | 🟢 verified | (tick A-20260713-1312 — 6556 palabras, 163 path:line, 7 diagramas ASCII, Gateway+agent loop+sandbox; 6/6) |
...
| JWIKI-009b | 01_LANDSCAPE/superpowers-code-audit.md | Superpowers code-audit (real code 2026-07-13) | extra | 🟢 verified | (tick A-20260713-1312 — clonado repo real, 7096 palabras, 14 skills catalogadas, 4 SKILL.md leídos completos, match-the-form principle; 6/6) |
| JWIKI-009c | 14_BEST_PRACTICES/skill-format-spec.md | SKILL.md format spec (derivado de Superpowers) | extra | 🟢 verified | (tick A-20260713-1312 — spec vivo para Aithera V1.1+ LSL, 6299 palabras, 12 snippets path:line, propuesta migración 5 fases V0.85→V1.1; 6/6) |
