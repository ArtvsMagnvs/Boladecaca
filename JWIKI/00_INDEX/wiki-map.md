...
| ID | Path | Título | Turno | Estado |
|---|---|---|---|---|
| JWIKI-019 | 05_AI_PROVIDERS/README.md | Matriz comparativa proveedores | B | 🔴 pending |
| JWIKI-020 | 05_AI_PROVIDERS/openai.md | OpenAI GPT-5 o-series | A | 🔴 pending |
| JWIKI-021 | 05_AI_PROVIDERS/anthropic.md | Anthropic Claude 4 | B | 🔴 pending |
| JWIKI-022 | 05_AI_PROVIDERS/gemini.md | Google Gemini 3 | A | 🔴 pending |
| JWIKI-023 | 05_AI_PROVIDERS/meta-llama.md | Meta Llama 4 | B | 🔴 pending |
| JWIKI-024 | 05_AI_PROVIDERS/deepseek.md | DeepSeek V4 | A | 🔴 pending |
| JWIKI-025 | 05_AI_PROVIDERS/mistral.md | Mistral | B | 🔴 pending |
| JWIKI-026 | 05_AI_PROVIDERS/qwen.md | Qwen (Alibaba) | A | 🔴 pending |
| JWIKI-027 | 05_AI_PROVIDERS/minimax.md | MiniMax | B | 🔴 pending |
| JWIKI-028 | 05_AI_PROVIDERS/xai-grok.md | xAI Grok 4.3 | A | 🔴 pending |
| JWIKI-029 | 05_AI_PROVIDERS/cohere.md | Cohere | B | 🔴 pending |
| JWIKI-030 | 05_AI_PROVIDERS/perplexity.md | Perplexity | A | 🔴 pending |
| JWIKI-031 | 05_AI_PROVIDERS/local-ollama.md | Ollama local-first | B | 🔴 pending |
| JWIKI-032 | 05_AI_PROVIDERS/local-lmstudio.md | LM Studio | A | 🔴 pending |
| JWIKI-033 | 05_AI_PROVIDERS/local-llamacpp.md | llama.cpp | B | 🔴 pending |
| JWIKI-034 | 05_AI_PROVIDERS/function-calling.md | Function calling por proveedor | A | 🔴 pending |
| JWIKI-035 | 05_AI_PROVIDERS/streaming.md | SSE streaming por proveedor | B | 🔴 pending |
| JWIKI-036 | 05_AI_PROVIDERS/pricing-comparison.md | Pricing input/output por 1M tokens | A | 🔴 pending |
| JWIKI-037 | 05_AI_PROVIDERS/context-windows.md | Tamaños de contexto | B | 🔴 pending |
| JWIKI-038 | 05_AI_PROVIDERS/rate-limits.md | Rate limits por proveedor | A | 🔴 pending |
| JWIKI-039 | 05_AI_PROVIDERS/sdks-comparison.md | SDKs oficiales vs community | B | 🔴 pending |
| JWIKI-040 | 05_AI_PROVIDERS/api-changes-history.md | Historial cambios API 2024-2026 | A | 🔴 pending |
| JWIKI-041 | 05_AI_PROVIDERS/multimodal.md | Capacidades multimodales | B | 🔴 pending |
| JWIKI-042 | 05_AI_PROVIDERS/chinese-providers.md | Proveedores chinos | A | 🔴 pending |
| JWIKI-043 | 05_AI_PROVIDERS/reliability.md | Confiabilidad y uptime | B | 🔴 pending |
| JWIKI-044 | 05_AI_PROVIDERS/selection-guide.md | Guía de selección por caso | A | 🔴 pending |

## 02_ARCHITECTURE

| ID | Path | Título | Turno | Estado |
|---|---|---|---|---|
| JWIKI-045 | 02_ARCHITECTURE/monolith-vs-microservices.md | Monolith vs microservices | B | 🔴 pending |
| JWIKI-046 | 02_ARCHITECTURE/client-server.md | Cliente único backend único (Aithera) | A | 🔴 pending |
| JWIKI-047 | 02_ARCHITECTURE/multi-client.md | Multi-cliente Electron Web Telegram PWA | B | 🔴 pending |
| JWIKI-048 | 02_ARCHITECTURE/event-driven.md | Event-driven vs request-response | A | 🔴 pending |
| JWIKI-049 | 02_ARCHITECTURE/async-patterns.md | Async patterns asyncio queues | B | 🔴 pending |
| JWIKI-050 | 02_ARCHITECTURE/sse-streaming.md | SSE Server-Sent Events | A | 🔴 pending |
| JWIKI-051 | 02_ARCHITECTURE/websocket-bidir.md | WebSocket bidireccional | B | 🔴 pending |
| JWIKI-052 | 02_ARCHITECTURE/plugin-architecture.md | Plugin vs monolith | A | 🔴 pending |
| JWIKI-053 | 02_ARCHITECTURE/hexagonal-ports.md | Hexagonal ports adapters | B | 🔴 pending |
| JWIKI-054 | 02_ARCHITECTURE/clean-architecture.md | Clean architecture | A | 🔴 pending |
| JWIKI-055 | 02_ARCHITECTURE/orchestrator-pattern.md | Orchestrator pattern (V1.0) | B | 🔴 pending |
| JWIKI-056 | 02_ARCHITECTURE/state-management-patterns.md | State management cross-client | A | 🔴 pending |

## 03_BACKEND

| ID | Path | Título | Turno | Estado |
|---|---|---|---|---|
| JWIKI-057 | 03_BACKEND/README.md | Comparativa frameworks backend | B | 🔴 pending |
| JWIKI-058 | 03_BACKEND/fastapi.md | FastAPI - en uso en Aithera | A | 🔴 pending |
| JWIKI-059 | 03_BACKEND/express.md | Express (Node.js) | B | 🔴 pending |
| JWIKI-060 | 03_BACKEND/tauri-backend.md | Tauri (Rust) backend | A | 🔴 pending |
| JWIKI-061 | 03_BACKEND/flask-vs-fastapi.md | Flask vs FastAPI | B | 🔴 pending |
| JWIKI-062 | 03_BACKEND/django-vs-fastapi.md | Django vs FastAPI | A | 🔴 pending |
| JWIKI-063 | 03_BACKEND/orms.md | ORMs SQLAlchemy Prisma Drizzle | B | 🔴 pending |
| JWIKI-064 | 03_BACKEND/sqlalchemy-2.md | SQLAlchemy 2.0 - en uso | A | 🔴 pending |
| JWIKI-065 | 03_BACKEND/databases.md | PostgreSQL SQLite MariaDB | B | 🔴 pending |
| JWIKI-066 | 03_BACKEND/postgresql.md | PostgreSQL - en uso | A | 🔴 pending |
| JWIKI-067 | 03_BACKEND/sqlite-fallback.md | SQLite fallback automático | B | 🔴 pending |
| JWIKI-068 | 03_BACKEND/migrations.md | Migraciones Alembic Prisma | A | 🔴 pending |
| JWIKI-069 | 03_BACKEND/alembic.md | Alembic - en uso | B | 🔴 pending |
| JWIKI-070 | 03_BACKEND/auth-oauth2.md | OAuth2 Authorization Code + PKCE | A | 🔴 pending |
| JWIKI-071 | 03_BACKEND/auth-jwt.md | JWT vs session | B | 🔴 pending |
| JWIKI-072 | 03_BACKEND/api-design-rest.md | REST API design | A | 🔴 pending |
| JWIKI-073 | 03_BACKEND/api-design-graphql.md | GraphQL por qué NO | B | 🔴 pending |
| JWIKI-074 | 03_BACKEND/api-design-trpc.md | tRPC alternativa moderna | A | 🔴 pending |
| JWIKI-075 | 03_BACKEND/async-lifespan.md | FastAPI lifespan patterns | B | 🔴 pending |
| JWIKI-076 | 03_BACKEND/exception-handling.md | Global exception handler | A | 🔴 pending |
| JWIKI-077 | 03_BACKEND/pydantic-v2.md | Pydantic v2 schemas | B | 🔴 pending |
| JWIKI-078 | 03_BACKEND/sqlite-postgres-migration.md | Migración SQLite a PostgreSQL | A | 🔴 pending |

## 04_FRONTEND

| ID | Path | Título | Turno | Estado |
|---|---|---|---|---|
| JWIKI-079 | 04_FRONTEND/README.md | Comparativa frameworks frontend | B | 🔴 pending |
| JWIKI-080 | 04_FRONTEND/react.md | React 18 - en uso | A | 🔴 pending |
| JWIKI-081 | 04_FRONTEND/vue-3.md | Vue 3 | B | 🔴 pending |
| JWIKI-082 | 04_FRONTEND/svelte-5.md | Svelte 5 | A | 🔴 pending |
| JWIKI-083 | 04_FRONTEND/solid-js.md | SolidJS | B | 🔴 pending |
| JWIKI-084 | 04_FRONTEND/state-zustand.md | Zustand - en uso | A | 🔴 pending |
| JWIKI-085 | 04_FRONTEND/state-redux.md | Redux Toolkit | B | 🔴 pending |
| JWIKI-086 | 04_FRONTEND/state-jotai.md | Jotai | A | 🔴 pending |
| JWIKI-087 | 04_FRONTEND/state-pinia.md | Pinia (Vue) | B | 🔴 pending |
| JWIKI-088 | 04_FRONTEND/3d-threejs.md | Three.js AICore | A | 🔴 pending |
| JWIKI-089 | 04_FRONTEND/3d-react-three-fiber.md | React Three Fiber | B | 🔴 pending |
| JWIKI-090 | 04_FRONTEND/animations-framer.md | Framer Motion - en uso | A | 🔴 pending |
| JWIKI-091 | 04_FRONTEND/animations-gsap.md | GSAP | B | 🔴 pending |
| JWIKI-092 | 04_FRONTEND/build-vite.md | Vite - en uso | A | 🔴 pending |
| JWIKI-093 | 04_FRONTEND/build-webpack.md | Webpack 5 | B | 🔴 pending |
| JWIKI-094 | 04_FRONTEND/desktop-electron.md | Electron - en uso | A | 🔴 pending |
| JWIKI-095 | 04_FRONTEND/desktop-tauri.md | Tauri vs Electron | B | 🔴 pending |
| JWIKI-096 | 04_FRONTEND/routing-hashrouter.md | HashRouter Electron file:// | A | 🔴 pending |
| JWIKI-097 | 04_FRONTEND/tailwind.md | Tailwind CSS - en uso | B | 🔴 pending |
| JWIKI-098 | 04_FRONTEND/design-system-dark.md | Dark-first design system | A | 🔴 pending |
| JWIKI-099 | 04_FRONTEND/useref-streaming.md | Patrón useRef para streaming | B | 🔴 pending |
| JWIKI-100 | 04_FRONTEND/shaders-glsl.md | Shaders GLSL custom AICore | A | 🔴 pending |

## 06_AGENTS

| ID | Path | Título | Turno | Estado |
|---|---|---|---|---|
| JWIKI-101 | 06_AGENTS/README.md | Comparativa frameworks agentes | B | 🔴 pending |
| JWIKI-102 | 06_AGENTS/langgraph-deep.md | LangGraph deep dive | A | 🔴 pending |
| JWIKI-103 | 06_AGENTS/crewai-deep.md | CrewAI deep dive | B | 🔴 pending |
| JWIKI-104 | 06_AGENTS/autogen-deep.md | AutoGen deep dive | A | 🔴 pending |
| JWIKI-105 | 06_AGENTS/custom-agent.md | Custom agent 200 lineas | B | 🔴 pending |
| JWIKI-106 | 06_AGENTS/aithera-agent-manager.md | Aithera AgentManager caso | A | 🔴 pending |
